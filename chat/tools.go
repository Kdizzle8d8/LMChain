...
func SendMessageWithTool(model string, messages []ToolCallMessage) (string, error) {
	//log.Println("Sending message with tool:", messages)
...
var Tools = []Tool{
	...
	},
	{
		...
		Function: Function{
			...
			Description: "Executes arbitrary Python code and returns the output as a string. May return an error if execution fails.",
			Parameters: Parameters{
				Type: "object",
				Properties: map[string]Property{
					"code": {
